...
class _BackdropState extends State<Backdrop>
  ...
  void initState() {
    ...
    // This creates an [AnimationController] that allows for animation
    // for the BackdropPanel. 0.00 means that the front panel is in "tab"
    // (hidden) mode, while 1.0 means the front panel is open.
  ...
  // the user might either tap its heading or the backdrop's menu icon.
  ...
  Widget _buildStack(BuildContext context, BoxConstraints constaints) {
    const double panelTitleHeight = 48.0;
    final Size panelSize = constaints.biggest;
